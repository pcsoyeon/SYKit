...
public class ChartProgressBar: UIView {
    ...
    public var emptyColor: UIColor = .gray
    public var progressColor: UIColor = .systemBlue
    public var progressDisableColor: UIColor = .systemCyan
    public var progressClickColor: UIColor = .systemMint
    ...
    public var barTitleColor: UIColor = .blue
    public var barTitleSelectedColor: UIColor = .white
